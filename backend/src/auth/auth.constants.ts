...
export const PASSWORD_CHANGE_TOKEN_TTL_SECONDS = 10 * 60;
...
export const JWT_PASSWORD_CHANGE_AUDIENCE = 'fixtradezone-password-change';
export const JWT_PASSWORD_CHANGE_ISSUER = 'fixtradezone-api';
...
export const GENERIC_LOGIN_ERROR = 'Invalid login credentials.';
...
export const GENERIC_PASSWORD_CHANGE_ERROR =
  'Invalid or expired password change request.';
