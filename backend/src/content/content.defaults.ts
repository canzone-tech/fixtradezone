...
> = {
  ...
  SUPPORT_TICKET_CREATED: {
    ...
    category: 'SUPPORT',
    description:
      'Transactional acknowledgement after a USER creates a support ticket.',
    transactional: true,
  },
  SUPPORT_TICKET_REPLY: {
    ...
    category: 'SUPPORT',
    description:
      'Transactional notice when support staff replies to a USER ticket.',
    transactional: true,
  },
  SUPPORT_TICKET_STATUS_CHANGED: {
    ...
    category: 'SUPPORT',
    description:
      'Transactional notice when support staff changes a ticket lifecycle status.',
    transactional: true,
  },
};
...
> = {
  ...
  SUPPORT_TICKET_CREATED: {
    ...
    footer:
      'For your security, do not email passwords, private keys, seed phrases, or authentication secrets.',
  },
  SUPPORT_TICKET_REPLY: {
    ...
    footer:
      'Ticket messages remain authoritative inside FixTradeZone. Email is notification transport only.',
  },
  SUPPORT_TICKET_STATUS_CHANGED: {
    ...
    ctaLabel: 'View ticket',
    footer:
      'Ticket status and history remain authoritative inside FixTradeZone.',
  },
};
