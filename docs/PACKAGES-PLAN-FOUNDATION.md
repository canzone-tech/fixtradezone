...
6. Implement the matching same-origin BFF and UI after explicit Founder approval
   to batch manual testing.
7. Run the corrected ordered Postman gate, SQL/audit readback and integrated
   ADMIN/USER browser acceptance together.
8. Update final milestone docs and rerun milestone verification.
9. Push/open a PR only after every local gate is green and Founder accepted.
